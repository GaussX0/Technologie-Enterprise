...
namespace MvcNews.Controllers
{
    public class NewsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,RowVersion")] NewsItem newsItem)
        {
            if (id != newsItem.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException e)
                {
                    ...
                    else
                    {
                        ...
                        ModelState.AddModelError("", "This news has been changed by another user.");
